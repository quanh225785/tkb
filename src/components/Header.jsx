...
import { Download, Save, BookOpen, ArrowLeft } from "lucide-react";
        ...
        {hasFile && (
          <nav className="step-nav">
            ...
            >
              ...
              {mySubjectsCount > 0 && (
                <span className="badge">{mySubjectsCount}</span>
              )}
            </button>
          </nav>
        )}
      ...
      {step === "schedule" && selectedCount > 0 && (
        <div className="header-progress">
          <div
            ...
            style={{
              width: `${mySubjectsCount ? (selectedCount / mySubjectsCount) * 100 : 0}%`,
            }}
          />
        </div>
      )}
