          ...
          {!hasGenerated ? (
            <div className="as-setup">
              ...
              <div className="as-section">
                ...
                <p className="as-hint" style={{ marginTop: '8px', fontStyle: 'italic' }}>
                  Lưu ý: Nếu chọn quá nhiều ngày nghỉ, hệ thống có thể không tìm ra cách xếp nào.
                </p>
              </div>

              <button className="payment-btn primary" onClick={handleGenerate} style={{ marginTop: '20px', width: '100%', padding: '12px' }}>
                🚀 Bắt đầu tạo lịch
              </button>
            </div>
          ) : (
            <div className="as-results">
              {results.length === 0 ? (
                <div className="as-empty">
                  ...
                  <button className="payment-btn secondary" onClick={() => setHasGenerated(false)} style={{ marginTop: '20px' }}>
                    Quay lại
                  </button>
                </div>
              ) : (
                  ...
                  <div className="as-preview-card">
                    <div className="as-preview-header">
                      ...
                      <div className="as-preview-meta">
                        ...
                        <span className="as-score-badge">Điểm tối ưu: {results[viewIndex].score}</span>
                      </div>
                      <button 
                        className="as-nav-btn" 
                    ...
                    <div className="as-preview-stats">
                      <span>🎒 Đi học: <strong>{results[viewIndex].daysWithClasses} ngày</strong></span>
                      <span>⏱️ Lỗ hổng kíp: <strong>{results[viewIndex].gapPeriods} kíp</strong></span>
                    </div>
